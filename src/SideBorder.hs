...
--
-- This version modified by Joshua Munn <public@elysee-munn.family> to
-- allow specifiying the colours of the borders of the side border
-- decoration.
module SideBorder
  ( -- * Usage
    -- $usage
...
data SideBorderConfig = SideBorderConfig
  { -- | Which side to have the border on.
    ...
    -- | Active border's border colour.
    sbActiveBorderColor :: !String,
    -- | Inactive border colour.
    sbInactiveColor :: !String,
    -- | Inactive border's border colour.
    sbInactiveBorderColor :: !String,
...
instance Default SideBorderConfig where
  ...
  def =
    SideBorderConfig
      { sbSide = D,
        sbActiveColor = "#ff0000",
        sbActiveBorderColor = "#ff0000",
        sbInactiveColor = "#ffaaaa",
        sbInactiveBorderColor = "#ffaaaa",
        sbSize = 5
      }
...
sideBorder sbc cfg =
  cfg
    { layoutHook = sideBorderLayout sbc (layoutHook cfg),
      borderWidth = 0
    }
